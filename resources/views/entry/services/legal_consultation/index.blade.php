...
@section('title', 'خدمات الاستشارات القانونية')
@section('page-title', 'سجل الاستشارات القانونية')

@section('content')
<div class="space-y-6 text-right font-medium" dir="rtl">
    <div class="flex items-center justify-between">
        <p class="text-sm text-gray-500 font-medium">تعبئة البيانات التفصيلية للاستشارات القانونية المخصصة</p>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($consultations as $item)
                        <tr class="hover:bg-gray-50/50 transition-colors group">
                            <td class="px-6 py-4 text-right">
                                ...
                                <p class="text-[11px] text-gray-400 mt-0.5">{{ $item->funder }}</p>
                            </td>
                            ...
                            <td class="px-6 py-4 text-left">
                                <div class="flex items-center justify-end gap-1">
                                    <a href="{{ route('data_entry.services.legal_consultation.edit', $item) }}" class="flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 text-indigo-700 rounded-lg text-[11px] font-bold hover:bg-indigo-100 transition-colors shadow-sm">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-20 text-center text-gray-400 font-bold font-medium">لا توجد استشارات قانونية متاحة حالياً</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
